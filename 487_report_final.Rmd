...
The labelled data in each of the datasets were selected at random and incorrect labels from the labelled subsets, were also selected at random. As a result, there may not equal proportions of labelled data that belong to each of the three clusters, despite the true cluster proportions created as equal.
...
Initial parameter estimates $\{\pi_r^{(0)}\}$, were set as the true proportions so that $\{\hat{\pi}_r^{(0)}\} = \{0.333, 0.333,0.333\}$. These parameters are not as essential for the evaluation of the clustering performance, so it is not as essential to use randomly assigned values.
...
\multicolumn{1}{l}{} & \multicolumn{1}{l}{} & \multicolumn{1}{l}{} & mean & s.d & mean & s.d & \multicolumn{1}{c}{mean} & \multicolumn{1}{c}{s.d} \\ \midrule
\multirow{9}{*}{\begin{tabular}[c]{@{}c@{}}Scenario 1:\\ \\ \((m = 10\%, s = 10\%)\)\end{tabular}} & \(\mu\) & 0.000 & -0.330 & 0.030 & -0.337 & 0.016 &  &  \\
 & \(\alpha_1\) & -2.000 & -1.520 & 0.030 & -1.512 & 0.016 &  &  \\
 & \(\alpha_2\) & 0.000 & -0.270 & 0.030 & -0.270 & 0.016 &  &  \\
 & \(\beta_1\) & -2.000 & -1.860 & 0.160 & -1.840 & 0.079 &  &  \\
 & \(\beta_2\) & -1.500 & -1.380 & 0.170 & -1.387 & 0.096 &  &  \\
 & \(\beta_3\) & 0.300 & 0.230 & 0.170 & 0.253 & 0.092 &  &  \\
 & \(\beta_4\) & 1.000 & 0.900 & 0.220 & 0.904 & 0.105 &  &  \\
 & \(\pi_1\) & 0.333 & 0.240 & 0.030 & 0.244 & 0.015 &  &  \\
 & \(\pi_2\) & 0.333 & 0.290 & 0.050 & 0.295 & 0.022 &  &  \\ \midrule
\multirow{9}{*}{\begin{tabular}[c]{@{}c@{}}Scenario 2:\\ \\ \((m = 10\%, s = 30\%)\)\end{tabular}} & \(\mu\) & 0.000 & -0.358 & 0.031 & -0.360 & 0.018 &  &  \\
 & \(\alpha_1\) & -2.000 & -1.490 & 0.031 & -1.488 & 0.018 &  &  \\
 & \(\alpha_2\) & 0.000 & -0.249 & 0.031 & -0.247 & 0.018 &  &  \\
 & \(\beta_1\) & -2.000 & -1.814 & 0.157 & -1.797 & 0.081 &  &  \\
 & \(\beta_2\) & -1.500 & -1.339 & 0.160 & -1.348 & 0.090 &  &  \\
 & \(\beta_3\) & 0.300 & 0.237 & 0.165 & 0.256 & 0.086 &  &  \\
 & \(\beta_4\) & 1.000 & 0.881 & 0.216 & 0.887 & 0.106 &  &  \\
 & \(\pi_1\) & 0.333 & 0.243 & 0.031 & 0.245 & 0.017 &  &  \\
 & \(\pi_2\) & 0.333 & 0.289 & 0.043 & 0.294 & 0.025 &  &  \\ \midrule
\multirow{9}{*}{\begin{tabular}[c]{@{}c@{}}Scenario 3:\\ \\ \((m = 10\%, s = 50\%)\)\end{tabular}} & \(\mu\) & 0.000 & -0.379 & 0.031 & -0.377 & 0.021 &  &  \\
 & \(\alpha_1\) & -2.000 & -1.470 & 0.031 & -1.472 & 0.021 &  &  \\
 & \(\alpha_2\) & 0.000 & -0.228 & 0.031 & -0.230 & 0.021 &  &  \\
 & \(\beta_1\) & -2.000 & -1.773 & 0.152 & -1.774 & 0.083 &  &  \\
 & \(\beta_2\) & -1.500 & -1.306 & 0.156 & -1.324 & 0.094 &  &  \\
 & \(\beta_3\) & 0.300 & 0.243 & 0.161 & 0.263 & 0.094 &  &  \\
 & \(\beta_4\) & 1.000 & 0.873 & 0.195 & 0.877 & 0.104 &  &  \\
 & \(\pi_1\) & 0.333 & 0.237 & 0.032 & 0.244 & 0.016 &  &  \\
 & \(\pi_2\) & 0.333 & 0.296 & 0.045 & 0.297 & 0.023 &  &  \\ \bottomrule
\end{tabular}
\end{table}
...
\textbf{Scenario} & \textbf{Param.} & \textbf{Truth} & \multicolumn{2}{c}{\(\mathbf{n=300}\)} & \multicolumn{2}{c}{\(\mathbf{n=1000}\)} & \multicolumn{2}{c}{\(\mathbf{n=3000}\)} \\
\multicolumn{1}{l}{} & \multicolumn{1}{l}{} & \multicolumn{1}{l}{} & mean & s.d & mean & s.d & \multicolumn{1}{c}{mean} & \multicolumn{1}{c}{s.d} \\ \midrule
\multirow{9}{*}{\begin{tabular}[c]{@{}c@{}}Scenario 4:\\ \\ \((m = 30\%, s = 10\%)\)\end{tabular}} & \(\mu\) & 0.000 & -0.317 & 0.040 & -0.326 & 0.022 &  &  \\
 & \(\alpha_1\) & -2.000 & -1.531 & 0.040 & -1.522 & 0.022 &  &  \\
 & \(\alpha_2\) & 0.000 & -0.290 & 0.040 & -0.281 & 0.022 &  &  \\
 & \(\beta_1\) & -2.000 & -1.831 & 0.166 & -1.805 & 0.078 &  &  \\
 & \(\beta_2\) & -1.500 & -1.351 & 0.183 & -1.346 & 0.104 &  &  \\
 & \(\beta_3\) & 0.300 & 0.240 & 0.188 & 0.267 & 0.103 &  &  \\
 & \(\beta_4\) & 1.000 & 0.897 & 0.220 & 0.903 & 0.119 &  &  \\
 & \(\pi_1\) & 0.333 & 0.268 & 0.024 & 0.268 & 0.013 &  &  \\
 & \(\pi_2\) & 0.333 & 0.309 & 0.031 & 0.311 & 0.019 &  &  \\ \midrule
\multirow{9}{*}{\begin{tabular}[c]{@{}c@{}}Scenario 5:\\ \\ \((m = 30\%, s = 30\%)\)\end{tabular}} & \(\mu\) & 0.000 & -0.382 & 0.039 & -0.389 & 0.023 &  &  \\
 & \(\alpha_1\) & -2.000 & -1.467 & 0.039 & -1.460 & 0.023 &  &  \\
 & \(\alpha_2\) & 0.000 & -0.225 & 0.039 & -0.218 & 0.023 &  &  \\
 & \(\beta_1\) & -2.000 & -1.711 & 0.160 & -1.704 & 0.085 &  &  \\
 & \(\beta_2\) & -1.500 & -1.245 & 0.166 & -1.265 & 0.099 &  &  \\
 & \(\beta_3\) & 0.300 & 0.252 & 0.172 & 0.264 & 0.091 &  &  \\
 & \(\beta_4\) & 1.000 & 0.858 & 0.215 & 0.855 & 0.104 &  &  \\
 & \(\pi_1\) & 0.333 & 0.263 & 0.027 & 0.270 & 0.014 &  &  \\
 & \(\pi_2\) & 0.333 & 0.316 & 0.034 & 0.308 & 0.019 &  &  \\ \midrule
\multirow{9}{*}{\begin{tabular}[c]{@{}c@{}}Scenario 6:\\ \\ \((m = 30\%, s = 50\%)\)\end{tabular}} & \(\mu\) & 0.000 & -0.433 & 0.044 & -0.443 & 0.024 &  &  \\
 & \(\alpha_1\) & -2.000 & -1.415 & 0.044 & -1.406 & 0.024 &  &  \\
 & \(\alpha_2\) & 0.000 & -0.174 & 0.044 & -0.164 & 0.024 &  &  \\
 & \(\beta_1\) & -2.000 & -1.644 & 0.160 & -1.631 & 0.078 &  &  \\
 & \(\beta_2\) & -1.500 & -1.196 & 0.177 & -1.191 & 0.093 &  &  \\
 & \(\beta_3\) & 0.300 & 0.260 & 0.166 & 0.270 & 0.087 &  &  \\
 & \(\beta_4\) & 1.000 & 0.821 & 0.185 & 0.808 & 0.100 &  &  \\
 & \(\pi_1\) & 0.333 & 0.267 & 0.027 & 0.272 & 0.017 &  &  \\
 & \(\pi_2\) & 0.333 & 0.314 & 0.033 & 0.307 & 0.023 &  &  \\ \bottomrule
\end{tabular}
\end{table}
...
\multicolumn{1}{l}{} & mean & s.d & mean & s.d & \multicolumn{1}{c}{mean} & \multicolumn{1}{c}{s.d} \\ \midrule
\begin{tabular}[c]{@{}c@{}}Scenario 1:\\ \((m = 10\%, s = 10\%)\)\end{tabular} & 0.672 & 0.052 & 0.692 & 0.023 &  &  \\
\begin{tabular}[c]{@{}c@{}}Scenario 2:\\ \((m = 10\%, s = 30\%)\)\end{tabular} & 0.677 & 0.049 & 0.690 & 0.027 &  &  \\
\begin{tabular}[c]{@{}c@{}}Scenario 3:\\ \((m = 10\%, s = 50\%)\)\end{tabular} & 0.673 & 0.049 & 0.690 & 0.026 &  &  \\
\begin{tabular}[c]{@{}c@{}}Scenario 4:\\ \((m = 30\%, s = 10\%)\)\end{tabular} & 0.686 & 0.041 & 0.693 & 0.016 &  &  \\
\begin{tabular}[c]{@{}c@{}}Scenario 5:\\ \((m = 30\%, s = 30\%)\)\end{tabular} & 0.682 & 0.047 & 0.693 & 0.016 &  &  \\
\begin{tabular}[c]{@{}c@{}}Scenario 6:\\ \((m = 30\%, s = 50\%)\)\end{tabular} & 0.688 & 0.039 & 0.693 & 0.016 &  &  \\ \bottomrule
\end{tabular}
\end{table}
...
\begin{table}[htbp]
\centering
\caption{Mean time in seconds spent to run the EM algorithm for each data scenario based on 100 replicated datasets.}
\vspace{.1in}
\label{tab:time}
\begin{tabular}{@{}ccccccc@{}}
\toprule
\textbf{n} & \textbf{S1} & \textbf{S2} & \textbf{S3} & \textbf{S4} & \textbf{S5} & \textbf{S6} \\ \midrule
300 & 45.2 & 43.4 & 44.0 & 29.0 & 26.7 & 26.6 \\
1000 & 130.6 & 125.8 & 126.6 & 90.6 & 85.3 & 88.8 \\
3000 & \multicolumn{1}{l}{} & \multicolumn{1}{l}{} & \multicolumn{1}{l}{} & \multicolumn{1}{l}{} & \multicolumn{1}{l}{} & \multicolumn{1}{l}{} \\ \bottomrule
\end{tabular}
\end{table}
\end{appendix}
